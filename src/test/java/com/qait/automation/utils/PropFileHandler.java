...
/**
 * 
 * @author QA InfoTech This class defines the methods required to perform IO
 *         tasks on the "filename.properties" file. filename.properties is the
 *         default file which stores data which either is required by the
...
public class PropFileHandler {
	...
	public static void deleteFile(String filePath) {
		...
		try {
			...
			if (file.exists()) {
				if (file.delete()) {
					System.out.println("Pass - File at " + filePath + "has been deleted.");
				}else {
					System.out.println("Delete operation -> Failed, although File exists.");
				}
			} else {
				System.out.println("Given File Do not exist.");
			}
